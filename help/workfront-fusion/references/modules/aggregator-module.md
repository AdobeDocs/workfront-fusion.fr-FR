...
description: Un module d’agrégation est un type de module conçu pour fusionner plusieurs bundles de données en un seul.
author: Becky
...
<table style="table-layout:auto">
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <p>Chaque bundle contient deux éléments :</p> 
    <ul> 
