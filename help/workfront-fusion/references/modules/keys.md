...
Vous pouvez mettre à jour une clé existante. Lorsque la clé est mise à jour, tous les scénarios qui l’utilisent utilisent la clé mise à jour.

1. Dans Fusion, cliquez sur Clés ![icône Clés](assets/keys-icon.png) dans le volet de navigation de gauche.
1. Sélectionnez la clé à modifier, puis cliquez sur Modifier dans la barre située en bas de l’écran.
1. Modifiez la clé selon vos besoins.
