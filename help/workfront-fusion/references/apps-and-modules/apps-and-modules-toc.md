...
title: 'Références des applications Fusion et leurs modules : index des articles'
description: Cette section contient des documents de référence relatifs à la configuration de modules spécifiques dans Adobe Workfront Fusion.
author: Becky
...
Fusion propose des connecteurs pour de nombreux produits et services Adobe.

* [Module Adobe App Builder](/help/workfront-fusion/references/apps-and-modules/adobe-connectors/adobe-app-builder.md)
...
* [Modules Adobe Firefly Lightroom](/help/workfront-fusion/references/apps-and-modules/adobe-connectors/adobe-firefly-lightroom.md)
...
## Outils et systèmes de transformation

Ces modules permettent d’effectuer des actions sur vos données mais ne nécessitent pas de connexion à un service en dehors de Fusion.
...
* [Module de l’agent MCP (Model Context Protocol)](/help/workfront-fusion/references/apps-and-modules/tools-and-transformers/model-context-protocol-mcp-connector.md)
