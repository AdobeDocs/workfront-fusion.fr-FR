---
title: Modules Frame.io (hérités)
description: Les modules [!DNL Adobe Workfront Fusion Frame].io vous permettent de surveiller, créer, mettre à jour, récupérer ou supprimer des ressources et des commentaires dans votre compte [!DNL Frame.io].
author: Becky
...
>[!IMPORTANT]
>
>Cet article décrit l’ancienne version du connecteur Frame.io. Ce connecteur est utilisé pour se connecter à la version 3 de Frame.io.
>
>Pour obtenir des instructions sur la nouvelle version (bêta) du connecteur Frame.io, voir [Connecteur Frame.io](/help/workfront-fusion/references/apps-and-modules/adobe-connectors/frame-io-modules-new.md).
...
Pour obtenir des instructions sur la nouvelle version du connecteur Frame.io, voir [Connecteur Frame.io](/help/workfront-fusion/references/apps-and-modules/adobe-connectors/frame-io-modules-new.md).
...
Pour connecter votre compte [!DNL Frame.io] à Workfront Fusion à l’aide d’un jeton API, vous devez créer le jeton API dans votre compte [!DNL Frame.io] et l’insérer dans la boîte de dialogue Workfront Fusion [!DNL Frame.io] [!UICONTROL Créer une connexion].
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Saisissez un chemin d’accès relatif à <code>https://api.frame.io</code>. Exemple : <code> /v2/teams</code></p> <p>Note : pour obtenir la liste des points d’entrée disponibles, voir la référence de l’API [!DNL Frame.io].</p> </td> 
  </tr> 
  <tr> 
