...
description: Avec le connecteur [!DNL Adobe Experience Manager Forms] pour Adobe Workfront Fusion, vous pouvez démarrer un scénario en fonction des événements se produisant dans votre compte [!DNL Adobe Experience Manager Forms], créer, charger et mettre à jour des ressources, et copier ou déplacer des dossiers et des ressources.
author: Becky
