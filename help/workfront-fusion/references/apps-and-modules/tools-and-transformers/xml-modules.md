...
1. Remplacez le nom de votre structure de données par un nom plus spécifique, puis cliquez sur **[!UICONTROL Save]**.
...
1. Créez un scénario.
1. Ajoutez le module [!UICONTROL HTTP] > [!UICONTROL Get a file] .
