...
Avec le connecteur [!DNL Airtable] pour Adobe Workfront Fusion, vous pouvez démarrer un scénario en fonction des événements de votre compte [!DNL Airtable], créer, charger et mettre à jour des enregistrements, rechercher des enregistrements et effectuer des appels d’API personnalisés vers l’API Airtable.
...
1. Indiquez si vous utilisez un jeton d’accès personnel ou une autorisation OAuth 2.
1. Saisissez un nom pour la connexion.
1. (Conditionnel) Si vous utilisez un jeton d’accès personnel, cliquez sur Afficher les paramètres avancés et saisissez votre jeton d’accès personnel.
1. (Conditionnel) Si vous utilisez OAuth 2, cliquez sur Afficher les paramètres avancés, puis saisissez votre identifiant client Airtable et votre secret client.
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Saisissez les valeurs du nouvel enregistrement. Les champs disponibles dépendent du tableau que vous avez sélectionné.</p> 
   <!--
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> <p>Enregistrement</p> </td> 
   <td> <p>Saisissez les valeurs du nouvel enregistrement. Les champs disponibles dépendent du tableau sélectionné.</p> 
   <!--
...
1. Saisissez l’URL Webhook générée à l’étape 2 dans la boîte de dialogue affichée et ajoutez le ?record_id={record_id} juste après l’URL webhook pour inclure l’ID d’enregistrement dans la sortie du module, puis cliquez sur Enregistrer. L’URL qui en résulte, par exemple, se présente comme suit :
...
Ce module d’action vous permet d’effectuer un appel personnalisé et authentifié vers l’API [!DNL Airtable]. Ainsi, vous pouvez créer une automatisation du flux de données qui ne peut pas être réalisée par les autres modules [!DNL Airtable].
