...
>[!NOTE]
>
>Workfront Fusion n’est pas une source de données. Workfront Fusion peut créer et utiliser des sources de données, mais elle ne stocke pas vos données.
...
Lorsque vous configurez [!DNL Power BI], Workfront Fusion affiche les champs répertoriés ci-dessous. En plus de cela, des champs supplémentaires peuvent s’afficher, selon des facteurs tels que votre niveau d’accès dans l’application ou le service. Un titre en gras dans un module indique un champ obligatoire.
...
Ce module de recherche permet de récupérer une liste de tableaux de bord.
...
Ce module de recherche permet de récupérer une liste de rapports.
...
Ce module de recherche permet de récupérer une liste de jeux de données.
...
Ce module de recherche permet de récupérer une liste de toutes les applications installées.
...
Ce module de recherche permet de récupérer une liste de tableaux de bord à partir d’une application donnée.
...
Ce module de recherche permet de récupérer une liste de tous les rapports de l’application spécifiée.
