      ...
      <td>
        ...
        <ul>
          ...
          <li>
            ...
            <p>Renvoie les nœuds référencés par les ID sous la forme d’un objet JSON. Les nœuds sont récupérés du fichier [!DNL Figma] auquel renvoie la [!UICONTROL Key].</p>
