...
Dans un scénario Adobe Workfront Fusion, vous pouvez automatiser les workflows qui utilisent [!DNL Bynder] et le connecter à plusieurs applications et services tiers.
...
<table style="table-layout:auto">
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td>
   <p>Basé sur les opérations : inclus</p>
...
Ce module d’action vous permet d’effectuer un appel personnalisé et authentifié vers l’API [!DNL Bynder]. Ainsi, vous pouvez créer une automatisation du flux de données qui ne peut pas être réalisée par les autres modules [!DNL Bynder].
...
<table style="table-layout:auto">
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td>Saisissez un chemin d’accès relatif à <code>https://{your-bynder-domain}/api/{api-version}/</code>.</td> 
  </tr> 
  <tr> 
