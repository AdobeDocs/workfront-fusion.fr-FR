...
Dans un scénario Adobe Workfront Fusion, vous pouvez automatiser les workflows qui utilisent [!DNL Microsoft Word Templates] et le connecter à plusieurs applications et services tiers.
...
## Utilisation des modules [!DNL Microsoft Word Templates]
