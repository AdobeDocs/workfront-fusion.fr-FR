...
Dans un scénario Adobe Workfront Fusion, vous pouvez automatiser les workflows qui utilisent [!DNL Quickbase] et le connecter à plusieurs applications et services tiers.
