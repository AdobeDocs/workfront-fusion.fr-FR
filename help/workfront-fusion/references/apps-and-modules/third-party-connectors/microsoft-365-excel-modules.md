 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Sélectionnez le mode d’identification du tableau que vous souhaitez récupérer.</p> 
    <ul> 
     <li> <p><strong>[!UICONTROL Enter manually]</strong> </p> <p>Dans le champ [!UICONTROL Workbook ID] , saisissez ou mappez l’identifiant du classeur contenant la table à récupérer.</p> <p>Dans le champ [!UICONTROL Table Name], saisissez ou mappez le nom de la table à récupérer.</p> </li> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Sélectionnez le mode d’identification du tableau à supprimer.</p> 
    <ul> 
     <li> <p><strong>[!UICONTROL Enter manually]</strong> </p> <p>Dans le champ [!UICONTROL Workbook ID] , saisissez ou mappez l’ID du classeur contenant la table à supprimer.</p> <p>Dans le champ [!UICONTROL Table Name] , saisissez ou mappez le nom de la table à supprimer.</p> </li> 
