...
Dans un scénario Adobe Workfront Fusion, vous pouvez automatiser les workflows qui utilisent [!DNL Workday] et le connecter à plusieurs applications et services tiers.
...
Ce module d’action vous permet d’effectuer un appel personnalisé et authentifié vers l’API [!DNL Workday]. Ainsi, vous pouvez créer une automatisation du flux de données qui ne peut pas être réalisée par les autres modules [!DNL Workday].
...
Ce module de recherche permet de récupérer une liste des enregistrements du type spécifié.
