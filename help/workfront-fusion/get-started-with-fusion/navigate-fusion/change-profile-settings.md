---
title: Modifier les paramètres de profil
description: Vous pouvez modifier les informations dans le profil de votre compte Adobe Workfront Fusion.
author: Becky
...
Vous pouvez modifier les informations dans le profil de votre compte Adobe Workfront Fusion.
...
* Accédez à votre **[!UICONTROL profil]**. Une fois que vous êtes sur le profil, cliquez sur le menu **[!UICONTROL Plus]** et sélectionnez **[!UICONTROL Modifier]**.
