---
title: 'Activité Version de Workfront Fusion : semaine du mardi 12 mai 2025'
description: 'Activité Version de Workfront Fusion : semaine du mardi 12 mai 2025'
author: Becky
...
# Activité de publication de Workfront Fusion : semaine du 12 mai 2025

Cette page décrit toutes les améliorations apportées à Adobe Workfront Fusion au cours de la semaine du mardi 12 mai 2025.
...
## Nouveau type de connexion disponible dans le connecteur DevOps d’Azure

Pour faciliter la requête de toutes les portées lors de la configuration d’une connexion dans les opérations de développement Azure, nous avons créé un nouveau type de connexion. Le type de connexion EntraApp Azure DevOps comprend un bouton (bascule) qui vous permet de demander toutes les portées de la connexion.

Pour obtenir des instructions sur la configuration de l’autorisation de certificat dans le connecteur DevOps d’Azure, voir [Connexion [!DNL Azure DevOps] à Workfront Fusion](/help/workfront-fusion/references/apps-and-modules/third-party-connectors/azure-dev-ops.md#connect-azure-devops-to-workfront-fusion) dans l’article Modules DevOps d’Azure.
