...
title: Gestion des scénarios dans la zone des Scénarios
...
# Gestion des scénarios dans la zone des Scénarios

Dans la zone Scénarios , vous pouvez afficher des informations sur les scénarios détenus par une équipe. Vous pouvez également cloner, déplacer ou supprimer des scénarios, ou les affecter à un pool de travail spécifique.
...
<table style="table-layout:auto">
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> Vous devez être administrateur de Fusion pour affecter un scénario à un pool de traitement. </td>
   </tr>
 </tbody> 
</table>
...
## Affichage et gestion des scénarios dans la zone des Scénarios
...
1. Pour déplacer un ou plusieurs scénarios vers un dossier, cochez la case en regard de chaque scénario à déplacer, puis cliquez sur **Déplacer vers un dossier** dans la barre située en bas de l’écran. Dans la fenêtre qui s’affiche, sélectionnez le dossier dans lequel vous souhaitez déplacer les scénarios, puis cliquez sur **Déplacer**.
